...
This repository accompanies the paper '[_Integrated design of augmented reality spaces using virtual environments_](https://ieeexplore.ieee.org/document/9995481)', in Proceedings of IEEE ISMAR 2022. Other projects which use Virtual-Inertial SLAM include (images link to GitHub repositories):
